...
const s = StyleSheet.create({
  page: { fontFamily: SANS, fontSize: 10, paddingTop: 44, paddingBottom: 44, paddingHorizontal: 52, color: '#1a1a1a' },
        ...
        {experience.length > 0 && (
          <View>
            ...
            {experience.map((exp, idx) => {
              ...
              return (
                <View key={exp.id} style={s.expWrapper}>
        ...
        {data.projects && data.projects.length > 0 && (
          <View>
            ...
            {data.projects.map((proj) => {
              ...
              return (
                <View key={proj.id} style={s.normalItem}>
        ...
        {education.length > 0 && (
          <View>
            ...
            {education.map((edu) => {
              ...
              return (
                <View key={edu.id} style={s.normalItem}>
                  <View style={s.itemRow}>
