export interface Translations {
  ...
  landing: {
    ...
    how1t: string; how1d: string; how2t: string; how2d: string; how3t: string; how3d: string;
    statFree: string; statTemplates: string; statLanguages: string; statDownloads: string;
  };
...
const en: Translations = {
  ...
  landing: {
    heroProof: '14 templates · 15 languages · 0 accounts · $0',
    howEyebrow: 'how it works',
    howHeading: 'Three steps to a finished resume',
    how1t: 'Fill in your details',
    how1d: 'The form walks you through section by section while the preview updates live. You can also import an existing CV from PDF.',
    how2t: 'Pick a template',
    how2d: '14 professional templates with color palettes. Switch any time without losing data.',
    how3t: 'Download the PDF',
    how3d: 'A clean file with no watermark and no fees. Download as many times as you like.',
    statFree: 'free forever',
    statTemplates: 'professional templates',
    statLanguages: 'language versions',
    statDownloads: 'download limit',
  },
...
const es: Translations = {
  ...
  landing: {
    heroProof: '14 plantillas · 15 idiomas · 0 cuentas · 0 €',
    howEyebrow: 'cómo funciona',
    howHeading: 'Tres pasos para un CV terminado',
    how1t: 'Rellena tus datos',
    how1d: 'El formulario te guía sección a sección mientras la vista previa se actualiza en vivo. También puedes importar un CV existente desde PDF.',
    how2t: 'Elige una plantilla',
    how2d: '14 plantillas profesionales con paletas de colores. Cambia cuando quieras sin perder datos.',
    how3t: 'Descarga el PDF',
    how3d: 'Un archivo limpio sin marca de agua y sin costes. Descárgalo tantas veces como quieras.',
    statFree: 'gratis para siempre',
    statTemplates: 'plantillas profesionales',
    statLanguages: 'versiones de idioma',
    statDownloads: 'límite de descargas',
  },
...
const fr: Translations = {
  ...
  landing: {
    heroProof: '14 modèles · 15 langues · 0 compte · 0 €',
    howEyebrow: 'comment ça marche',
    howHeading: 'Trois étapes vers un CV terminé',
    how1t: 'Renseignez vos informations',
    how1d: 'Le formulaire vous guide section par section pendant que l\'aperçu se met à jour en direct. Vous pouvez aussi importer un CV existant en PDF.',
    how2t: 'Choisissez un modèle',
    how2d: '14 modèles professionnels avec palettes de couleurs. Changez à tout moment sans perdre vos données.',
    how3t: 'Téléchargez le PDF',
    how3d: 'Un fichier propre, sans filigrane et sans frais. Téléchargez autant de fois que vous voulez.',
    statFree: 'gratuit pour toujours',
    statTemplates: 'modèles professionnels',
    statLanguages: 'versions linguistiques',
    statDownloads: 'limite de téléchargements',
  },
...
const de: Translations = {
  ...
  landing: {
    heroProof: '14 Vorlagen · 15 Sprachen · 0 Konten · 0 €',
    howEyebrow: 'so funktioniert es',
    howHeading: 'Drei Schritte zum fertigen Lebenslauf',
    how1t: 'Daten ausfüllen',
    how1d: 'Das Formular führt Sie Abschnitt für Abschnitt, während die Vorschau live aktualisiert wird. Sie können auch einen bestehenden Lebenslauf aus PDF importieren.',
    how2t: 'Vorlage wählen',
    how2d: '14 professionelle Vorlagen mit Farbpaletten. Jederzeit wechseln, ohne Daten zu verlieren.',
    how3t: 'PDF herunterladen',
    how3d: 'Eine saubere Datei ohne Wasserzeichen und ohne Kosten. So oft herunterladen, wie Sie möchten.',
    statFree: 'für immer kostenlos',
    statTemplates: 'professionelle Vorlagen',
    statLanguages: 'Sprachversionen',
    statDownloads: 'Download-Limit',
  },
...
const pt: Translations = {
  ...
  landing: {
    heroProof: '14 modelos · 15 idiomas · 0 contas · R$ 0',
    howEyebrow: 'como funciona',
    howHeading: 'Três passos para um currículo pronto',
    how1t: 'Preencha seus dados',
    how1d: 'O formulário guia você seção por seção enquanto a pré-visualização atualiza ao vivo. Você também pode importar um currículo existente de um PDF.',
    how2t: 'Escolha um modelo',
    how2d: '14 modelos profissionais com paletas de cores. Troque quando quiser sem perder dados.',
    how3t: 'Baixe o PDF',
    how3d: 'Um arquivo limpo, sem marca d\'água e sem custos. Baixe quantas vezes quiser.',
    statFree: 'grátis para sempre',
    statTemplates: 'modelos profissionais',
    statLanguages: 'versões de idioma',
    statDownloads: 'limite de downloads',
  },
...
const zh: Translations = {
  ...
  landing: {
    heroProof: '14 个模板 · 15 种语言 · 0 个账户 · 0 元',
    howEyebrow: '使用方法',
    howHeading: '三步完成简历',
    how1t: '填写信息',
    how1d: '表单逐节引导你填写，预览实时更新。也可以从 PDF 导入现有简历。',
    how2t: '挑选模板',
    how2d: '14 个专业模板与配色方案，随时切换不丢数据。',
    how3t: '下载 PDF',
    how3d: '干净的文件，无水印无费用，想下载多少次都可以。',
    statFree: '永久免费',
    statTemplates: '专业模板',
    statLanguages: '语言版本',
    statDownloads: '下载限制',
...
const ja: Translations = {
  ...
  landing: {
    heroProof: 'テンプレート14種 · 15言語 · アカウント不要 · 0円',
    howEyebrow: '使い方',
    howHeading: '3ステップで履歴書が完成',
    how1t: '情報を入力',
    how1d: 'フォームがセクションごとに案内し、プレビューはリアルタイムで更新されます。既存のPDF履歴書のインポートも可能です。',
    how2t: 'テンプレートを選択',
    how2d: '14種類のプロ仕様テンプレートとカラーパレット。データを失わずにいつでも切り替えられます。',
    how3t: 'PDFをダウンロード',
    how3d: '透かしなし、料金なしのきれいなファイル。何度でもダウンロードできます。',
    statFree: 'ずっと無料',
    statTemplates: 'プロ仕様テンプレート',
    statLanguages: '言語バージョン',
    statDownloads: 'ダウンロード制限',
  },
...
const ko: Translations = {
  ...
  landing: {
    heroProof: '템플릿 14종 · 15개 언어 · 계정 불필요 · 0원',
    howEyebrow: '이용 방법',
    howHeading: '세 단계로 완성되는 이력서',
    how1t: '정보 입력',
    how1d: '폼이 섹션별로 안내하고 미리보기가 실시간으로 업데이트됩니다. 기존 PDF 이력서를 가져올 수도 있습니다.',
    how2t: '템플릿 선택',
    how2d: '14가지 전문 템플릿과 색상 팔레트. 데이터 손실 없이 언제든 전환하세요.',
    how3t: 'PDF 다운로드',
    how3d: '워터마크와 비용이 없는 깔끔한 파일. 원하는 만큼 다운로드하세요.',
    statFree: '영구 무료',
    statTemplates: '전문 템플릿',
    statLanguages: '언어 버전',
    statDownloads: '다운로드 제한',
  },
...
const ar: Translations = {
  ...
  landing: {
    heroProof: '14 قالباً · 15 لغة · بلا حساب · 0',
    howEyebrow: 'طريقة العمل',
    howHeading: 'ثلاث خطوات لسيرة ذاتية جاهزة',
    how1t: 'أدخل بياناتك',
    how1d: 'يرشدك النموذج قسماً بقسم بينما تتحدث المعاينة مباشرة. يمكنك أيضاً استيراد سيرة ذاتية موجودة من PDF.',
    how2t: 'اختر قالباً',
    how2d: '14 قالباً احترافياً مع لوحات ألوان. بدّل في أي وقت دون فقدان البيانات.',
    how3t: 'نزّل ملف PDF',
    how3d: 'ملف نظيف بلا علامة مائية وبلا رسوم. نزّله كما تشاء.',
    statFree: 'مجاني للأبد',
    statTemplates: 'قوالب احترافية',
    statLanguages: 'نسخ لغوية',
    statDownloads: 'حد للتنزيلات',
  },
...
const ru: Translations = {
  ...
  landing: {
    heroProof: '14 шаблонов · 15 языков · 0 аккаунтов · 0 ₽',
    howEyebrow: 'как это работает',
    howHeading: 'Три шага до готового резюме',
    how1t: 'Заполните данные',
    how1d: 'Форма ведёт вас раздел за разделом, а предпросмотр обновляется вживую. Можно также импортировать существующее резюме из PDF.',
    how2t: 'Выберите шаблон',
    how2d: '14 профессиональных шаблонов с цветовыми палитрами. Переключайтесь без потери данных.',
    how3t: 'Скачайте PDF',
    how3d: 'Чистый файл без водяного знака и без оплаты. Скачивайте сколько угодно.',
    statFree: 'бесплатно навсегда',
    statTemplates: 'профессиональных шаблонов',
    statLanguages: 'языковых версий',
    statDownloads: 'лимита скачиваний',
  },
...
const it: Translations = {
  ...
  landing: {
    heroProof: '14 modelli · 15 lingue · 0 account · 0 €',
    howEyebrow: 'come funziona',
    howHeading: 'Tre passi per un CV finito',
    how1t: 'Inserisci i tuoi dati',
    how1d: 'Il modulo ti guida sezione per sezione mentre l\'anteprima si aggiorna in tempo reale. Puoi anche importare un CV esistente da PDF.',
    how2t: 'Scegli un modello',
    how2d: '14 modelli professionali con palette di colori. Cambia quando vuoi senza perdere i dati.',
    how3t: 'Scarica il PDF',
    how3d: 'Un file pulito, senza filigrana e senza costi. Scaricalo tutte le volte che vuoi.',
    statFree: 'gratis per sempre',
    statTemplates: 'modelli professionali',
    statLanguages: 'versioni linguistiche',
    statDownloads: 'limite di download',
  },
...
const hi: Translations = {
  ...
  landing: {
    heroProof: '14 टेम्पलेट · 15 भाषाएँ · 0 खाते · ₹0',
    howEyebrow: 'यह कैसे काम करता है',
    howHeading: 'तैयार रेज़्यूमे तक तीन कदम',
    how1t: 'अपनी जानकारी भरें',
    how1d: 'फ़ॉर्म आपको सेक्शन दर सेक्शन ले चलता है और प्रीव्यू लाइव अपडेट होता है। आप PDF से मौजूदा CV भी इंपोर्ट कर सकते हैं।',
    how2t: 'टेम्पलेट चुनें',
    how2d: '14 पेशेवर टेम्पलेट और रंग पैलेट। बिना डेटा खोए कभी भी बदलें।',
    how3t: 'PDF डाउनलोड करें',
    how3d: 'बिना वॉटरमार्क और बिना शुल्क की साफ़ फ़ाइल। जितनी बार चाहें डाउनलोड करें।',
    statFree: 'हमेशा मुफ़्त',
    statTemplates: 'पेशेवर टेम्पलेट',
    statLanguages: 'भाषा संस्करण',
    statDownloads: 'डाउनलोड सीमा',
  },
...
const tr: Translations = {
  ...
  landing: {
    heroProof: '14 şablon · 15 dil · 0 hesap · 0 TL',
    howEyebrow: 'nasıl çalışır',
    howHeading: 'Bitmiş bir CV için üç adım',
    how1t: 'Bilgilerinizi girin',
    how1d: 'Form sizi bölüm bölüm yönlendirir, önizleme canlı güncellenir. Mevcut bir CV\'yi PDF\'ten içe de aktarabilirsiniz.',
    how2t: 'Şablon seçin',
    how2d: 'Renk paletleriyle 14 profesyonel şablon. Veri kaybetmeden istediğiniz zaman değiştirin.',
    how3t: 'PDF\'i indirin',
    how3d: 'Filigransız ve ücretsiz temiz bir dosya. İstediğiniz kadar indirin.',
    statFree: 'sonsuza dek ücretsiz',
    statTemplates: 'profesyonel şablon',
    statLanguages: 'dil sürümü',
    statDownloads: 'indirme sınırı',
  },
...
const nl: Translations = {
  ...
  landing: {
    heroProof: '14 sjablonen · 15 talen · 0 accounts · 0 €',
    howEyebrow: 'hoe het werkt',
    howHeading: 'Drie stappen naar een afgerond cv',
    how1t: 'Vul je gegevens in',
    how1d: 'Het formulier leidt je sectie voor sectie terwijl het voorbeeld live bijwerkt. Je kunt ook een bestaand cv uit PDF importeren.',
    how2t: 'Kies een sjabloon',
    how2d: '14 professionele sjablonen met kleurpaletten. Wissel wanneer je wilt zonder gegevens te verliezen.',
    how3t: 'Download de PDF',
    how3d: 'Een schoon bestand zonder watermerk en zonder kosten. Download zo vaak je wilt.',
    statFree: 'voor altijd gratis',
    statTemplates: 'professionele sjablonen',
    statLanguages: 'taalversies',
    statDownloads: 'downloadlimiet',
  },
...
const pl: Translations = {
  ...
  landing: {
    heroProof: '14 szablonów · 15 języków · 0 kont · 0 zł',
    howEyebrow: 'jak to działa',
    howHeading: 'Trzy kroki do gotowego CV',
    how1t: 'Wypełnij dane',
    how1d: 'Formularz prowadzi Cię sekcja po sekcji, a podgląd aktualizuje się na żywo. Możesz też zaimportować istniejące CV z PDF.',
    how2t: 'Wybierz szablon',
    how2d: '14 profesjonalnych szablonów z paletami kolorów. Przełączaj w każdej chwili bez utraty danych.',
    how3t: 'Pobierz PDF',
    how3d: 'Czysty plik bez znaku wodnego i bez opłat. Pobieraj ile chcesz.',
    statFree: 'za darmo na zawsze',
    statTemplates: 'profesjonalnych szablonów',
    statLanguages: 'wersji językowych',
    statDownloads: 'limitu pobrań',
  },
